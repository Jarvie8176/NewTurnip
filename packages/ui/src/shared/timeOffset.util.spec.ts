...
describe("timeOffset", () => {
  ...
  describe("nextValidTime", () => {
    ...
    it("with negative time diff", () => {
      ...
      const expectedNextValidTime = moment("2000-01-02T01:00:00Z", ISO_8601); // 5 hours behind in local time (12pm in local)
    ...
    it("with time diff more than one day", () => {
      ...
      const expectedNextValidTime = moment("2000-01-02T08:00:00.000Z", ISO_8601); // 5 hours behind in local time (12pm in local)
